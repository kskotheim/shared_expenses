...
class Style {
  ...
  static final BoxDecoration selectAccountDecoration = BoxDecoration(border: Border.all(color: _darkBrown), borderRadius: BorderRadius.all(Radius.circular(12.0)), gradient: LinearGradient(begin: Alignment.topRight, end: Alignment.bottomLeft, colors: [_lightGreen, _darkGreen]));
  static final BoxDecoration selectAccountDecorationOwner = BoxDecoration(border: Border.all(color: _darkBrown), borderRadius: BorderRadius.all(Radius.circular(12.0)), gradient: LinearGradient(begin: Alignment.topRight, end: Alignment.bottomLeft, colors: [_lightGreen, _lightBrown]));
  static final BoxDecoration editDeleteDecoration = BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(5.0)), border: Border.all(color: _darkBrown), gradient: LinearGradient(begin: Alignment.centerLeft, end: Alignment.centerRight, colors: [Colors.redAccent, Colors.orangeAccent]));
  static final BoxDecoration editDeleteDecorationReverse = BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(5.0)), border: Border.all(color: _darkBrown), gradient: LinearGradient(begin: Alignment.centerLeft, end: Alignment.centerRight, colors: [Colors.orangeAccent, Colors.redAccent]));
  ...
  static const Color _darkBrown = const Color(0xff3e3e3c);
  static const Color _lightBrown = const Color(0xffe8e9c9);
  static const Color _darkGreen = const Color(0xff228d57);
  static const Color _lightGreen = const Color(0xff85bb65);
